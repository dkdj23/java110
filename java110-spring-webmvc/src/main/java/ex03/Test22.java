...
public class Test22 {
    ...
    //    반드시 포함해야 한다.
    //
    // ## HttpMessageConverter 는 스프링에 기본 포함되지 않음.
    //    이미 유명한 Jackson2HttpMessage 과 GsonHttpMessage 라이브러리가 있기 때문
    //
    ...
    // 클라이언트가 보낸 JSON 데이터를 변수에 받기
    // 
    @RequestMapping("m6")
    public String m6(@RequestBody String jsonData) throws Exception {
        System.out.println(jsonData);
        return "ex02.Test22.m6()";
    }
    
    // => JSON 문자열 ---> Car 객체로 deserialize
    @RequestMapping("m7") // JSON parsing 해서 car 에 꽂아준다. HttpMessageConverter
    public String m7(@RequestBody Car car) throws Exception {
        System.out.println(car);
        return "ex02.Test22.m7()";
    }
