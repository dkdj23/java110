...
public class Test25 {
    ...
    // 테스트:
    //   http://localhost:8888/app/ex03/test25/search/car/red/true/2013
    ...
    public String m1(
        ...
        return String.format("car=%s,color=%s,auto=%b,year=%d",car,color,auto,year);
    }
    ...
    //
    // 테스트:
    //   http://localhost:8888/app/ex03/test25/search2/car=sonata;color=red;auto=true;year=2013
    //
    ...
    public String m2(
        ...
        return String.format("value=%s,car=%s,color=%s,auto=%b,year=%d",value,car,color,auto,year);
    }
    
    // 테스트:
    //   http://localhost:8888/app/ex03/test25/search3/model;(/)car=sonata;color=red/spec;(/)auto=true;year=2013
    //
    
    @RequestMapping("search3/model/{value1}/spec/{value2}")
    public String m3(
    ...
    // 테스트:
    //   .../search4/car/model=sonata;year=2013/tire/model=비트타이어;year=2018
    //
    ...
    public String m4(
            // PathVariable 이 다르고
            // 매트릭스 변수 이름이 같을 때(중복될떄..model과 year가 2개씩)
    ...
    //
    // 테스트:
    //    .../search5/{l1:[0-9][0-9]}{l2:[0-9][0-9]}{l3[0-9][0-9]}{l4[0-9][0-9]}{no:[0-9]+}_{yr:[0-9]+}{ver:[a-z0-9]+}
