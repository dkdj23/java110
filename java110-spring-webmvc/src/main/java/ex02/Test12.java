...
public class Test12 {
    ...
    @RequestMapping("m1")
    @ResponseBody
    public String m1(ServletRequest req, ServletResponse res) {
    ...
    @RequestMapping("m2")
    @ResponseBody
    public String m2(HttpServletRequest req, HttpServletResponse res) {
        System.out.println(req);
        System.out.println(res);
    ...
    // ServletContext 는 파라미터로 받을 수 없다.
    // 대신 필드로 받아야 한다.
    @RequestMapping("m4")
    @ResponseBody
