...
public class LoginServlet extends HttpServlet {
    ...
    protected void doGet(
        ...
        // 쿠키 데이터에 email 이 있다면 입력 폼에 출력한다.
        String email = "";
        ...
        if(email.equals("")) {
            ...
            out.println("<td><input type='checkbox' name='save' checked>이메일 저장</td>");
        }
        out.println("</tr>");
        out.println("<tr>");
        out.println("<th></th>");
