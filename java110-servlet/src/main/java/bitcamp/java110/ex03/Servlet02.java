...
public class Servlet02 extends GenericServlet {
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        //    조합형 - 16비트. 아레아한글 규칙. 초성(5비트), 중성(5비트), 종성(5비트) 로 표현.
        //          3만자 이상의 모든 한글 문자를 표기할 수 있다. 국제표준 아님.
        //    MS949(CP949) - 16비트. MS OS의 코드표 (국제표준아님). 
        //                   EUC-KR(2350자) + 8822자 = 11172자
        //    Unicode(UTF-16) - 16비트. 국제 표준이다.
        //                   한글은 11172자가 정의되어 있다.
        //                   단점?영어도 2바이트로 표현된다. 영어권 애들 싫어함 1byte면 됬었는데....
        //    UTF-8        - 1 ~ 4바이트로 문자 표현. 국제 표준이다.
        //                   유니코드의 변형이다.
        //                   한글은 규칙에 따라 3바이트로 표현한다.
        //                   영어는 ISO-8859-1 코드 그대로 1바이트로 표현한다.(그래서 외국애들은 UTF-8사용) 
