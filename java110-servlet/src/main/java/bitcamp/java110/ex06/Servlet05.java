 ...
 *    즉 모든 서블릿이 공유해야 하는 정보는 컨텍스트 초기화 파라미터로 선언하라!
 * => 활용
 *    DB 연결정보, 파일업로드 설정 정보 등
 */    
...
public class Servlet05 extends HttpServlet {
    ...
    public Servlet05() {
        System.out.println("ex06.Servlet05...생성자 호출됨!");
    }
    
    @Override
    public void init() throws ServletException {
        System.out.println("ex06.Servlet05.init()..호출됨!");
    }
    ...
    public void service(
        ...
        // => 먼저 서블릿 환경 정보를 다루는 ServletContet 객체를 얻는다.
