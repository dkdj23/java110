...
public class Filter01 implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        // 필터가 생성된 후 생성자 호출 후 이 메서드를 호출한다.
    ...
    public void doFilter(
        ...
        //
        // 서블릿을 싱행하기 전에 하는 일
        // 예) 클라이언트가 암호화해서 보낸 데이터를 서블릿이 사용할 수 있도록 암호 해제하기
        //    클라이언트가 압축해서 보낸 데이터를 서블릿이 사용할 수 있도록 압축 해제하기
    ...
    public void destroy() {
        ...
        // init() 에서 준비한 자원을 해제시킨다.
        System.out.println("Filter01.destroy() 호출됨");
    }
}
 ...
 * - 따라서 필터 순서에 의존하는 방식으로 프로그래밍 해서는 안된다.   
 */        
...
Filter02.doFilter() --- before
service() 호출됨
Filter02.doFilter() --- after
Filter01.doFilter() --- after
 */
