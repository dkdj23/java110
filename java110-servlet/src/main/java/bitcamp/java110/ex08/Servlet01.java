...
@WebServlet(value="/ex08/servlet01")
public class Servlet01 extends HttpServlet {
    ...
    public void doGet(
        ...
        // sendRedirect()를 호출하기 전에 버퍼의 내용을 브라우저로 출력한다면?
        // => sendRedirect는 무시된다.
        out.flush();
        ...
        // 질문2) 버퍼가 꽉차면 어떻게 되나요?
        // => 그럼 자동으로 출력한다.
        // => 따라서 출력했기 떄문에 sendRedirect()는 무시된다. 또는 에러.
    }
}
...
Content-Length: 0
Date: Fri, 28 Sep 2018 05:30:33 GMT 

<=== message-body가 없다. 클라이언트가 출력할 내용을 보내지 않는다.
 */
