...
CREATE TABLE p2_lect (
    ...
    supt  CHAR(1)      NOT NULL COMMENT '정부지원여부', -- 정부지원여부
    cno   INTEGER      NULL     COMMENT '강의실번호', -- 강의실번호
...
CREATE TABLE p2_cls_room (
    cno  INTEGER     NOT NULL COMMENT '강의실번호', -- 강의실번호
...
ALTER TABLE p2_cls_room
    MODIFY COLUMN cno INTEGER NOT NULL AUTO_INCREMENT COMMENT '강의실번호';
...
CREATE TABLE p2_subj (
    ...
    titl VARCHAR(50) NOT NULL COMMENT '강의과목명' -- 강의과목명
)
COMMENT '과목';
...
CREATE TABLE p2_memb (
    ...
    dtl_addr VARCHAR(255) NULL     COMMENT '상세주소' -- 상세주소
)
COMMENT '회원';
